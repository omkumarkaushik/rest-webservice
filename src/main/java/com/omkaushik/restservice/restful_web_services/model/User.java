...
public class User {
	...
	public User(Integer id, @Size(min = 2, message = "Username must be of at least two characters") String name,
			@Past(message = "Date of birth should always be in past") LocalDate dateOfBirth, Post posts) {
		super();
		this.id = id;
		this.name = name;
		this.dateOfBirth = dateOfBirth;
